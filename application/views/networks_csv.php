<div class="container">
<h2>Networks <small>CSV Import & Export</small></h2>
...
<div class="row">
    ...
    <div class="col-sm-4" text-right>
        ...
        <i class="glyphicon glyphicon-backward"></i> Return Networks</button>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-9">
        <form name="export_data" id="export_data" method="post" action="<?php echo base_url("networks/export_csv"); ?>">
